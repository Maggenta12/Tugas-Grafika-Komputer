...
void Demo::BuildTexturedCube()
{
	...
	float vertices[] = {
		...
		1.5,  0.5, 0.5, 1, 1,  0.0f,  0.0f,  1.0f, // 2
		-1.5,  0.5, 0.5, 0, 1, 0.0f,  0.0f,  1.0f, // 3

		 // right
		 1.5,  0.5,  0.5, 0, 0, 1.0f,  0.0f,  0.0f, // 4
		 1.5,  0.5, -0.5, 1, 0, 1.0f,  0.0f,  0.0f, // 5
		 1.5, -0.5, -0.5, 1, 1, 1.0f,  0.0f,  0.0f, // 6
		 1.5, -0.5,  0.5, 0, 1, 1.0f,  0.0f,  0.0f, // 7

		// back
		-1.5, -0.5, -0.5, 0, 0, 0.0f,  0.0f,  -1.0f, // 8 
		1.5,  -0.5, -0.5, 1, 0, 0.0f,  0.0f,  -1.0f, // 9
		1.5,   0.5, -0.5, 1, 1, 0.0f,  0.0f,  -1.0f, // 10
		-1.5,  0.5, -0.5, 0, 1, 0.0f,  0.0f,  -1.0f, // 11

		 // left
		 -1.5, -0.5, -0.5, 0, 0, -1.0f,  0.0f,  0.0f, // 12
		 -1.5, -0.5,  0.5, 1, 0, -1.0f,  0.0f,  0.0f, // 13
		 -1.5,  0.5,  0.5, 1, 1, -1.0f,  0.0f,  0.0f, // 14
		 -1.5,  0.5, -0.5, 0, 1, -1.0f,  0.0f,  0.0f, // 15

		// upper
		1.5, 0.5,  0.5, 0, 0,   0.0f,  1.0f,  0.0f, // 16
		-1.5, 0.5, 0.5, 1, 0,   0.0f,  1.0f,  0.0f, // 17
		-1.5, 0.5, -0.5, 1, 1,  0.0f,  1.0f,  0.0f, // 18
		1.5, 0.5, -0.5, 0, 1,   0.0f,  1.0f,  0.0f, // 19

		// bottom
		-1.5, -0.5, -0.5, 0, 0, 0.0f,  -1.0f,  0.0f, // 20
		1.5, -0.5, -0.5, 1, 0,  0.0f,  -1.0f,  0.0f, // 21
